# Generated by Django 3.1.4 on 2021-01-07 06:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0007_auto_20210106_1451'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый заказ'), ('in_progress', 'Заказ в рьпаьрике'), ('is_ready', 'Заказ готов'), ('completed', 'Заказ выполнен')], default='new', max_length=100, verbose_name='Статус заказ')),
