...
class Product(models.Model):
    ...
    """def save(self, *args, **kwargs):
       ...
       # image = self.image
        ...
        #    filestream, 'ImageFiels', name, 'jpeg/image', sys.getsizeof(filestream), None
        #)
...
class Smartphone(Product):
    ...
    sd_volime_max = models.CharField(max_length=255, null=True, blank=True, verbose_name='Максимальный объем встраиваеой памяти')
    main_cam_mp = models.CharField(max_length=255, verbose_name='Главаная камера')
...
class Order(models.Model):
    ...
    STATYS_CHOICES = (
        ...
        (STATUS_IN_PROGRESS, 'Заказ в рьпаьрике'),
